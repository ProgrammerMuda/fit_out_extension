...
import { ShieldCheck, FilePdf, CheckCircle, Eye } from '@phosphor-icons/react';
import { Button, Modal } from 'react-bootstrap';

export function FitoutInspectionPassCard() {
  const [showPreview, setShowPreview] = useState(false);
  const fileName = 'INSPECTION_PASS_FP_104_1785834464.PDF';
      ...
      <Modal show={showPreview} onHide={() => setShowPreview(false)} size="lg" centered>
        ...
        <Modal.Body className="p-4 text-center">
          <div className="border rounded-3 p-5 bg-light">
            ...
            <p className="text-muted small mb-3">Dokumen Berita Acara Kelulusan Inspeksi Fitout Resmi</p>
